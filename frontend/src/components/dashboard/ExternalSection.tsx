...
const METRICS: { key: string; label: string; unit: string; color: string; yMin?: number; yMax?: number }[] = [
  { key: 'radiation',   label: 'Irradiance Solaire',  unit: 'W/m²', color: '#f97316', yMin: 0 },
  { key: 'wind_speed',  label: 'Vitesse du Vent',     unit: 'km/h', color: '#06b6d4', yMin: 0 },
  { key: 'humidity',    label: 'Humidité Extérieure', unit: '%',    color: '#3b82f6', yMin: 0, yMax: 100 },
  { key: 'temperature', label: 'Température Ext.',    unit: '°C',   color: '#f59e0b' },
  { key: 'rain',        label: 'Précipitations',      unit: 'mm',   color: '#22c55e', yMin: 0 },
  { key: 'battery_v',   label: 'Batterie Capteur',    unit: 'V',    color: '#a855f7' },
]
